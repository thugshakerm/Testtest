...
## 9. Fobe / Alphaland exact-source addendum

Source: [`gtoriadotnet/fobe-web`](https://github.com/gtoriadotnet/fobe-web), branch `production`, commit `651e01de0fc78d87d0cc2bc8d64c044cb22079a9` (2022-12-06, “Rename Finobe to Fobe”). The repository declares no license.

The updated `styleguide.html` includes these files verbatim rather than reconstructing their output:

- `globals/pageHandler.php`
- `html/index.php`
- `html/home/index.php`
- `html/profile/view.php`
- `html/games/index.php`
- `html/catalog/index.php`
- `html/fobe/css/stylesheet.css`
- `html/fobe/css/stylesheet-dark.css`
- `html/fobe/js/utilities.js`
- `html/fobe/js/snowfall/canvas-snow.js`

Its Fobe/Alphaland asset sheet loads each file directly from
`raw.githubusercontent.com/gtoriadotnet/fobe-web/production/html/fobe/cdn/imgs/`.
No dynamic values are fabricated: PHP and API-dependent regions remain visible as their exact committed source because rendering them would require the original database, authentication state, routes, and external APIs.
